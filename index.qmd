...
(function() {
  var data = [
    { year: '2006', caption: 'Mission begins', photos: [
      ...
      { src: 'images/project-images/mission_trip_photos/biong_mission_trip_photos_06.JPG', desc: 'Community gathering during the first mission outreach', pos: 'center 50%' }
    ]},
    ...
    { year: '2018', caption: 'Healthcare & relief', photos: [
    ...
    { year: '2020', caption: 'Mentorship & growth', photos: [
