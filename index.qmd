...
(function() {
  var data = [
    ...
    { year: '2007', caption: 'Mission Trip', photos: [
      { src: 'images/project-images/biong-women-carrying-water.png', desc: 'Women carrying water in Biong', pos: 'center 40%' },
      { src: 'images/project-images/biong-missionary-team-photo.png', desc: 'Mission team gathers in Biong during outreach', pos: 'center 35%' }
    ]},
    { year: '2008', caption: 'Education & community', photos: [
      ...
      { src: 'images/project-images/mission_trip_photos/biong_mission_trip_photos_03.jpg', desc: 'Mission team building relationships with local families', pos: 'center 45%' },
      ...
      { src: 'images/project-images/2008_photos/classroom_photos-04.jpg', desc: 'Patients gathered under a tree at the open-air clinic', pos: 'center 50%' },
