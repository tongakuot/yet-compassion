...
<script>
(function() {
  // One curated photo per year — clean, dignified, no internal cycling.
  var data = [
    { year: '2006', caption: 'Mission begins',
      src: 'images/project-images/biong-mission-team-2006.jpg',
      desc: 'First mission team reaches Biong, South Sudan',
      pos: 'center 65%' },
    { year: '2007', caption: 'Mission Trip',
      src: 'images/project-images/biong-missionary-team-photo.png',
      desc: 'Mission team gathers in Biong during outreach',
      pos: 'center 35%' },
    { year: '2008', caption: 'Education & community',
      src: 'images/project-images/2008_photos/classroom_photos-01.jpg',
      desc: 'Students engaged in learning under shelter',
      pos: 'center 45%' },
    { year: '2009', caption: 'Clean water & relief',
      src: 'images/project-images/water_well_photos/water_well_photos_02.JPG',
      desc: 'Community accessing clean water from the new well',
      pos: 'center 50%' },
    { year: '2012', caption: 'Education',
      src: 'images/project-images/biong-teacher-with-students.jpg',
      desc: 'Teacher with students in the classroom',
      pos: 'center 35%' }
  ];

  var yearIdx = 0, timer = null;
  ...
  data.forEach(function(p) {
    if (p.src) { var preload = new Image(); preload.src = p.src; }
  });

  // Build year pips — one dot per year
  data.forEach(function(g, i) {
    var pip = document.createElement('button');
    pip.textContent = g.year;
    pip.className = 'hero-pip';
    pip.style.cssText = 'font-family:Inter,sans-serif;font-size:0.65rem;font-weight:600;padding:0.2rem 0.55rem;border-radius:3px;border:1px solid rgba(255,255,255,0.12);background:transparent;color:rgba(255,255,255,0.4);cursor:pointer;transition:all 200ms ease;white-space:nowrap;letter-spacing:0.03em;';
  ...
  function advance() {
    yearIdx = (yearIdx + 1) % data.length;
    render();
  }

  function goBack() {
    yearIdx = (yearIdx - 1 + data.length) % data.length;
    render();
  }
...
<section class="reveal-on-scroll" style="background-color: #FFFFFF; padding: 3.5rem 1.5rem;">
  <div style="max-width: 780px; margin: 0 auto; text-align: left;">
    ...
    <p style="font-family: 'Inter', sans-serif; font-size: 1.1rem; line-height: 1.8; color: #5A5955; margin-bottom: 1.25rem;">
      Youth Evangelism Training (Y.E.T.) Compassion equips South Sudanese diaspora youth with the <strong>Gospel of Christ</strong> and the practical skills to <strong>lead with integrity</strong>, <strong>build stable families</strong>, and <strong>transform their communities</strong>. Every program is grounded in Scripture, shaped by mentorship, and built for lasting impact.
    </p>
