...
<section id="hero-slider" style="position: relative; width: 100%; height: 55vh; min-height: 380px; max-height: 529px; overflow: hidden; background: #0d0d0d;">
  ...
  <div style="position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(0,0,0,0.15) 0%, rgba(0,0,0,0.4) 40%, rgba(0,0,0,0.5) 70%, rgba(0,0,0,0.65) 100%); z-index: 2;"></div>

  <!-- Milestone card overlay (hidden by default) -->
  <div id="hero-milestone" style="display: none; position: absolute; inset: 0; background: linear-gradient(135deg, #1F5E3B 0%, #0f3320 100%); z-index: 3; align-items: center; justify-content: center; flex-direction: column; text-align: center; padding: 2rem;">
    <span style="font-size: 3.5rem; margin-bottom: 0.75rem; color: #C9A227; filter: drop-shadow(0 0 12px rgba(201,162,39,0.3));">✝</span>
    <span style="font-family: 'Playfair Display', serif; font-size: clamp(1.4rem, 2.5vw, 2rem); font-weight: 600; color: #FFF; line-height: 1.4; letter-spacing: -0.01em;">Y.E.T. Compassion<br>officially registered</span>
    <span style="font-family: 'Inter', sans-serif; font-size: 0.85rem; font-weight: 400; color: rgba(255,255,255,0.55); margin-top: 0.75rem; letter-spacing: 0.05em;">501(c)(3) · Nashville, TN · 2025</span>
  </div>
...
(function() {
  var data = [
    { year: '2006', caption: 'Mission begins', photos: [
      ...
      { src: 'images/project-images/biong-missionary-team-photo.png', desc: 'Missionary team on the ground in Biong', pos: 'center 40%' }
    ]},
    { year: '2007', caption: 'Flood relief', photos: [
      { src: 'images/project-images/biong-boat-transport-flood-2007.jpg', desc: 'Boat transport to reach flood-affected communities', pos: 'center 50%' },
      { src: 'images/project-images/biong-women-carrying-water.png', desc: 'Women carrying water during the crisis', pos: 'center 40%' }
    ]},
    { year: '2009', caption: 'Clean water', photos: [
      { src: 'images/project-images/biong-well-drilling-operator.jpg', desc: 'Clean water wells drilled for Biong village', pos: 'center 30%' },
      { src: 'images/project-images/biong-well-pipe-installation.jpg', desc: 'Well pipe installation underway', pos: 'center 35%' },
    ...
    { year: '2012', caption: 'Education', photos: [
      ...
      { src: 'images/project-images/biong-school-photo.png', desc: 'Students and community gathered at Biong School', pos: 'center 45%' },
    ...
    { year: '2015', caption: 'Faith & worship', photos: [
      { src: 'images/project-images/biong-church-service-rainy-day.png', desc: 'Faithful worship — church service in rainy season', pos: 'center 45%' }
    ]},
    { year: '2018', caption: 'Food relief', photos: [
      ...
      { src: 'images/project-images/biong-children-with-food-aid.jpg', desc: 'Children receiving food aid', pos: 'center 40%' },
      { src: 'images/project-images/biong-women-with-food-aid.jpg', desc: 'Women collecting food supplies for their families', pos: 'center 40%' }
    ]},
    { year: '2025', caption: '501(c)(3) registered', photos: [
      { src: '', desc: 'Y.E.T. Compassion officially registered as a 501(c)(3) nonprofit in Nashville, TN', milestone: true }
    ]}
  ];
  ...
  var milestoneEl = document.getElementById('hero-milestone');
  ...
  <div style="position: relative; z-index: 2; max-width: 1000px; margin: 0 auto;">
    ...
    <div id="impact-grid" style="display: grid; grid-template-columns: 3fr 2fr; gap: 0.75rem;">
      ...
      <div style="position: relative; overflow: hidden; border-radius: 10px; grid-row: 1 / 3;">
        <img loading="lazy" src="images/project-images/biong-school-photo.png" alt="Students and community gathered at Biong School" style="width: 100%; height: 100%; object-fit: cover; min-height: 360px;">
        <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.8)); padding: 1.25rem; padding-top: 3rem;">
          <span style="font-family: 'Inter', sans-serif; font-size: 0.9rem; font-weight: 600; color: #FFFFFF; display: block; margin-bottom: 0.25rem;">School Assembly — Biong Mission</span>
          <span style="font-family: 'Inter', sans-serif; font-size: 0.75rem; color: rgba(255,255,255,0.7);">Students and community gathered for learning</span>
        </div>
      </div>
      <!-- Top right -->
